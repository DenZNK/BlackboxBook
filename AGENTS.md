...
Книга **«От чёрного ящика к инженерии»** — практическое руководство по механике LLM, промпт-протоколам, агентным контурам и AI-friendly разработке. Контекст — апрель 2026: фронтирные модели (Claude Opus 4.6 и выше, GPT-5.4 и выше (включая Pro), Gemini 3.1 Pro, Grok 4.2, Llama 4, DeepSeek-V3, Qwen3 и выше), гибридные архитектуры (Transformer + Mamba/SSM + MoE), reasoning через test-time compute, агенты в production.
...
| Путь | Назначение |
|------|-----------|
| `book/` | Основной редактируемый корпус. 18 глав: `00_введение.md` … `17_резюме_и_источники.md` |
...
| 14–15 | Внедрение | AI-friendly код, LDD (Log-Driven Development), минимальный контур, метрики |
| 16 | Ландшафт | Гибриды (Mamba + Transformer + MoE), reasoning-модели, Diffusion LLM, экономика inference |
| 17 | Резюме | Девять принципов LLM-инженерии, общий список источников |
