...
Книга разбита на 24 главы и идёт от механики модели к архитектуре систем:
...
- **Глава 21:** внедрение — минимальный контур, метрики, постепенная интеграция;
- **Глава 22:** ландшафт 2026 — гибридные архитектуры, reasoning-модели, MoE, SSM/Mamba, экономика inference;
- **Глава 23:** резюме и первоисточники.
