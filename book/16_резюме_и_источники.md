...
Transformer — не единственная архитектура. В 2023–2025 годах появились **State Space Models** (Mamba, Gu & Dao, 2023), которые обрабатывают длинные последовательности за линейное время вместо квадратичного. Гибридные архитектуры (**Jamba** — Transformer + Mamba, AI21 Labs, 2024) комбинируют сильные стороны обоих подходов.
...
- **Практический вывод**: выбирайте архитектуру под задачу. Чистый Transformer — лучший in-context learner. SSM — эффективнее на длинных потоках. Гибрид — компромисс. Test-time compute — когда нужна максимальная точность на сложных задачах.
...
| 52 | Anthropic | 2024 | *The Claude 3 Model Family: Opus, Sonnet, Haiku* |
| 53 | Meta | 2024 | *Llama 3.1: Herd of Models* |
| 54 | Mistral AI | 2024 | *Mixtral of Experts* |
| 55 | DeepSeek | 2024 | *DeepSeek-V3 Technical Report* |
| 56 | Google | 2024 | *Gemini: A Family of Highly Capable Multimodal Models* |
| 57 | DeepSeek | 2025 | *DeepSeek-V3.2 Technical Report* |
| 58 | Meta | 2025 | *Llama 4: Maverick and Scout Technical Report* |
...
| Архитектуры (Transformer → SSM → гибриды) | Протокольный подход к промптам |
| Стоимость за токен (падает ~10× в год) | U-образная кривая attention и проблемы длинного контекста |
...
| API-интерфейсы провайдеров | MCP как стандарт интеграции инструментов |
