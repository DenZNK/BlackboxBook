...
Подробнее о memory architectures (session, episodic, semantic) — в [Главе 10, §10.5](10_агент_не_чат.md).
...
Стратегии compaction — sliding window, summarization, selective retention, pinned messages — подробно описаны в [Главе 10, §10.5](10_агент_не_чат.md). Здесь — то, что специфично для durable orchestration: взаимодействие compaction с checkpointing, стратегии запуска и обогащение long-term memory.
...
Cross-reference: OpenTelemetry spans и LLM-specific observability — [Глава 17](17_наблюдаемость_и_эксплуатация.md); trace-level eval — [Глава 14, §14.10](14_оценка_качества_llm_систем.md).
