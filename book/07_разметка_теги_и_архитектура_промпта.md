...
> **DSPy.** Фреймворк DSPy (2024–2026) формализовал подобные паттерны в виде *сигнатур* — типизированных описаний вход→выход. Сигнатура `"review: str -> sentiment: str, aspects: list[Aspect]"` автоматически превращается в структурированный промпт. Если вы работаете с DSPy — думайте о паттернах как о сигнатурах.
