# ГЛАВА 14. АРХИТЕКТУРА КОДА, ДРУЖЕСТВЕННАЯ ИИ
...
## 14.1. Маленькие модули лучше монолита
...
## 14.2. Контракт функции как фиксатор смысла
...
## 14.3. Zero-Context Survival: код должен работать без промпта
...
## 14.4. "Small Simple Blocks": линейный код лучше переинжиниренного DRY
...
## 14.5. Как писать код, который AI легко модифицирует
...
## 14.6. Как AI-агенты читают ваш код
...
## 14.7. Конфигурация AI на уровне проекта
...
## 14.8. Миграция: от монолита к AI-friendly коду
...
- Далее: [Глава 15. Как начать: от первого промпта до рабочего агентного контура](15_как_начать.md)
