# ГЛАВА 21. КАК НАЧАТЬ: ОТ ПЕРВОГО ПРОМПТА ДО РАБОЧЕГО АГЕНТНОГО КОНТУРА
...
## 21.1. Где агентный подход уже выгоден
...
## 21.2. Выбор модели: дерево решений
...
## 21.3. Инфраструктура: API, self-hosted или гибрид
...
## 21.4. Минимальный агентный контур
...
## 21.5. Как вводить ИИ постепенно
...
## 21.6. Метрики, которые нужно измерять
...
## 21.7. Типичные ошибки при внедрении
...
## 21.8. Минимальный запуск: чек-лист первой недели
...
## 21.10. Архитектура развёртывания
...
- Далее: [Глава 22. Ландшафт 2026](22_ландшафт_2026.md)
